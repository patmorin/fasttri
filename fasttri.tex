...
% The argument that the quotient graph $H:=G/\mathcal{P}$ has treewidth at most $8$ is constructive in the sense that is produces a tree-decomposition of $H$ in which each bag has size at most 9.
